...
/**
 * As 16 funções que chamam app_user_role_exigido() (0093 + 0094, D23, 0128 #352, 0142 #529).
 */
...
/**
 * As 9 funções que chamam app_user_id_exigido() (0093 + 0094, D23, 0112 #392, 0114 #393, 0115 #407, 0121 #119, 0143 #539, 0149 #554).
 *
 * #554 (0149) — `app_alerta_risco_visivel` e `app_alerta_trecho_fonte` SAÍRAM

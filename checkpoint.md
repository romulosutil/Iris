...
5. ~~**Passo 9: #322**~~ — **executado nesta sessão** (§1). Com ele **a ordem de conclusão da linha de billing termina**: os 9 passos estão fechados. O que sobra da linha não é passo, é medição em produção (itens 7 e 8) e leitura na interface (item 6). ⚠️ O **D39** ficou **mais** concreto, não menos: a varredura agora produz `EXCEEDED_MAXIMUM_RETRY_ATTEMPTS`, que é G6 e não persiste `recusa_codigo` — o caso hipotético virou caminho de código vivo.
...
| Achado                                                                                                                                                                                                                     | Onde                                                                              | Estado                                                                                                                                                                                                                                                                                                       |
| :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :-------------------------------------------------------------------------------- | :----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Qual campo a cobrança de ativação de fato traz nunca foi medido** — a classificação dela se apoia em "chega sem referência **e** sem instrução"                                                                          | `src/lib/billing/erro-aplicacao.ts` (docblock do classificador)                   | **Não medido, e o bloqueio é estrutural:** o sandbox não ativa Pix Automático. Se em produção a ativação chegar **com** instrução, ela vira alarme falso e barulhento. Escrito no docblock como falsificador nº 3. Entra no ensaio com clínica de teste. Virou **D43**.                                      |

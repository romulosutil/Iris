...
## 4. Verificação Atual da Base (`fix/330-n-plus-1-materializar-snapshot`)

| Gate                        | Resultado                                              |
| :-------------------------- | :----------------------------------------------------- |
| `pnpm typecheck`            | 0 erros                                                |
| `pnpm lint`                 | 0 erros                                                |
| `pnpm test`                 | 241/241 arquivos · 1.710/1.710 testes verdes           |
| `src/lib/evidence/materializar.test.ts` | 4/4 testes unitários de batch e contagem verdes |
...
1. Merge das PRs **#412**, **#413**, **#414**, **#415**, **#416** e **#417** (#330 / D40).
2. **D34**: Adicionar `audit_log` atômico no corte por inadimplência (`scripts/fechamento-ciclo-billing.mjs`).
3. **#383**: Implementar Webhook do Resend para log de bounces/complaints de e-mails transacionais.

...
describe("vencimento da cobrança de ciclo", () => {
  ...
  // Teto de 5s do vitest não cabe: a varredura roda 730 iterações, cada uma
  // resolvendo feriados móveis, e mede ~5,4s em máquina carregada. Cortar a
  // varredura para caber no default é o que NÃO se pode fazer — ela é o único
  // teste que pega o bug sazonal.
  it(

...
export default async function PacienteLayout({
  ...
  const abas: TabsNavItem[] = [
    ...
    // logic.ts/page.tsx): sem esse filtro a aba levaria a um 404. O eixo é o
    // papel, não a modalidade — o RPD serve tanto o paciente convencional
    // quanto o protocolar, então este filtro é ortogonal ao de `metas`.

...
export function DisponibilidadeEditor({
  terapeutaId, passoMin, celulasIniciais,
}: { terapeutaId: string; passoMin: number; celulasIniciais: Set<string> }) {
  const [state, formAction] = useActionState<SalvarJanelasState, FormData>(salvarJanelasAction, {});

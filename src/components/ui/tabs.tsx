...
>(function TabsTrigger({ className, ...props }, ref) {
  return (
    <TabsPrimitive.Trigger
      ref={ref}
      className={cn(
        // Margem negativa na unidade da régua (px), não em `rem`: ver `TabsNav`.
        "font-display -mb-[var(--border-brutal-width)] inline-flex min-h-11 items-center border-2 border-transparent px-4 py-2 text-base font-semibold text-[var(--text-secondary)] transition-colors duration-100 ease-out",

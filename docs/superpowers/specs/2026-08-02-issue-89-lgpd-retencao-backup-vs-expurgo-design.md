...
> _"Seus dados pessoais foram eliminados do banco de dados ativo da plataforma Iris em [Data/Hora]. Para fins de resiliência e recuperação de desastres, cópias de segurança cifradas são expurgadas automaticamente no ciclo de rotação em até 30 dias."_

...
- **RPD no Diário Narrativo:** Na sessão, o terapeuta anota o relato do paciente. O agente de IA extrai automaticamente a estrutura do RPD: _Situação $\rightarrow$ Pensamento Automático $\rightarrow$ Emoção (Intensidade 0-100%) $\rightarrow$ Categorização da Distorção Cognitiva $\rightarrow$ Resposta Racional_.

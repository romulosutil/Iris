...
Atualizar o §6 dos Termos de Uso para formalizar: *"A exportação de dados clínicos será fornecida em formato PDF/A auditável contendo marca d'água de emissão e assinatura de integridade via hash SHA-256."*

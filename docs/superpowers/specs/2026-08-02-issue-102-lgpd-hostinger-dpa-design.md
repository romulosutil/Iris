...
- Corrigir a frase do trecho de infraestrutura para separar _localização física do banco de dados (São Paulo, Brasil)_ do _domicílio da operadora (Hostinger International Ltd, UE)_.

### 2.3 Atualização da Política de Privacidade (`docs/legal/politica-privacidade.md`)

- Incluir na seção de Subprocessadores de Infraestrutura as categorias nominais: _"Hospedagem em nuvem (Hostinger International Ltd - Datacenter São Paulo/BR)"_.

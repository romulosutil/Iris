...
> **Nota de revisão — 02/09/2026 (auditoria 360, achado `PR-06`).** O corpo
> abaixo é a análise original de jul/2026 e foi mantido como registro da
> decisão de escopo. Ele **não** descreve mais o estado do produto: vários
> itens marcados 🔴/🟡 foram implementados entre jul e set/2026. A tabela
> "Estado em 09/2026" logo abaixo é a leitura vigente. **Regra:** este mapa
> é revisado a cada milestone fechada — quem fecha a milestone atualiza a
> tabela e a data desta nota; um agente novo lê a tabela, não o corpo.

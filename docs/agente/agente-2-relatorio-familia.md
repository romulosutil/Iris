...
pesquisa simulada (persona "Marcos"): _"eu percebo quando estão dourando a
pílula, e isso mina a confiança em tudo que veio antes."_
...
```json
{
  ...
  "trabalhando_agora": ["Nomear objetos do dia a dia"],
  "como_apoiar_em_casa": [

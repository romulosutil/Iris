...
export type ElevationNivel = "flat" | "raise" | "base" | "hover" | "inset" | "overlay";
export type RadiusNivel = "none" | "xs" | "sm" | "control" | "md" | "lg" | "xl" | "2xl" | "pill";
...
export interface PillProps extends React.HTMLAttributes<HTMLSpanElement> {
  ...
  colorScheme?: "neutral" | "brand" | "menta" | "ouro" | "violeta" | "azul" | "coral";
  size?: "sm" | "md";

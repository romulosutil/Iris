...
| `docs/arquitetura/pwa-e-cache.md`                       | Política de cache do Service Worker do PWA e medição Lighthouse mobile                                                                                                                                                                      |
| `docs/arquitetura/publicacao-play-store.md`             | Publicar o app Android na Play Store (TWA): o que já está pronto vs. o que só o Rômulo executa                                                                                                                                              |

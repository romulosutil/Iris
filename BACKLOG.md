...
**Gates:** `typecheck` 0 · `lint` 0 erros / 8 warnings pré-existentes · `test` 3175/3175 (369 arquivos) · `test:rls` 1424/1424 (162 arquivos, inclui o int-test novo 3/3 contra banco real) · carga da imagem `iris-alarme` 7/7 (nenhum Dockerfile mudou — a fatia não acrescenta import).

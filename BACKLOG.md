...
| **4** | `BACKLOG.md` (este arquivo)                                                                               | Débitos vivos (D1–D46) e log de sessões. Consulta, não leitura linear — venha buscar o histórico de uma decisão específica.                                                                                    |
...
| **D45** | **O contador de 3 tentativas do Asaas pode ser por instrução, não por cobrança — e a varredura escolhe sempre a instrução recusada mais recente.** A escolha deixou de ser `lista[0]` (arbitrária, dependente da ordem que a API devolvesse) e passou a ser determinística: a mais recente por `dateCreated`, com o maior `id` como desempate. Isso é correto se o orçamento de 3 for **por cobrança**. Se for **por instrução**, retentar sempre a mais nova **abre orçamento além de 3** — e o Asaas passa a debitar mais vezes do que a política autoriza. `src/lib/billing/provider/asaas.ts`. **Não medido**; aguardando primeiro ciclo real de recusa por saldo. Nasceu na #322, 17/08/2026.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| **D46** | **`purpose` e `retryAttempt` nunca apareceram em payload real, e o guard que impede o carimbo triplo depende dos dois.** `normalizarEventoAsaas` lê `paymentInstruction.purpose` (`SCHEDULE` \| `RETRY_AFTER_DUE_DATE`) e `retryAttempt` (1..3) de um envelope **lido da doc, nunca medido** — o mesmo envelope que já estava marcado como não medido desde 15/08. Se a doc estiver errada, os dois voltam `null` **em silêncio**, sem exceção e sem log: o guard nunca dispara, e uma recusa de retentativa é indistinguível da recusa original, então o Iris carimba `past_due` sobre o mesmo ciclo até 3 vezes e reescreve o diagnóstico da recusa que importava. Consequência gêmea: o guard corrigido nesta sessão (não engolir recusa de causa diferente) também só **acorda** quando o campo chegar. A conferência é ler o `bruto` do primeiro `INSTRUCTION_REFUSED` de retentativa em produção. Nasceu na #322, 17/08/2026.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| **D47** | **`docs/agente/protocolo-terapia-convencional.md` §3 e `casos-de-teste-terapia-convencional.md` usam forma antiga de `alerta_risco`/`temas`, predatando #122/R20.** `alerta_risco` na doc de protocolo é `{presente: boolean, categoria, trecho_fonte, detalhe}`; o contrato executável (`agentOutputSchema`, unificado nos 3 modos pela #390) é `{categoria, severidade, certeza, trecho_fonte, detalhe}` nullable, ausência = `null`, sem `presente`. `temas` na fixture do Caso TC-1 é array de objetos (`{tema, trecho_fonte}`); o contrato é `string[]`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   | Achado na pesquisa da #390 (18/08/2026): a doc de protocolo e a fixture de caso-de-teste divergem do que já está implementado e em produção. Não bloqueou #390 (doc de protocolo/caso-de-teste são artefatos separados do contrato executável), mas fica pendente de correção.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    | #390 · `docs/agente/protocolo-terapia-convencional.md` §3 · `docs/agente/casos-de-teste-terapia-convencional.md` (Caso TC-1) · `src/lib/extraction/agent-output-schema.ts`                  |
...
| **D52** | **`scripts/seed-demo-account.ts` cria todas as contas de demonstração com a senha literal `SenhaLocal123!`, e o script resolve o alvo por `MIGRATION_DATABASE_URL ?? DATABASE_URL` — a mesma variável que aponta para produção.** Nada no script distingue banco local de banco real: não há guard de host, de nome de banco, nem confirmação interativa.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       | Rodar `pnpm seed:custom` com o `.env` de produção carregado cria 7 usuários reais com senha pública e conhecida. O risco não é o literal no repositório (é um seed local, e está declarado): é a ausência de fronteira entre local e prod no ponto de escrita.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    | `scripts/seed-demo-account.ts` (`senhaPadrao`, resolução de `DATABASE_URL`) · `package.json` (`seed:custom`)                                                                                |
| **D53** | **Ferramenta de preview de UI injeta `<script src="http://localhost:8400/live.js">` em `src/app/layout.tsx` e a injeção sobrevive na árvore de trabalho até alguém reparar.** Foi revertida à mão em 20/08/2026 antes dos commits desta rodada; nada impede a reinjeção na próxima sessão de design.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            | Se um commit levar a tag junto, produção passa a pedir um script em `localhost` no `<body>` de toda página: falha silenciosa no cliente do usuário e um pedido de rede a um host que não é nosso. `pnpm build` e a suíte passam com a tag presente — nenhum gate atual pega.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      | `src/app/layout.tsx` (marcadores `impeccable-live-start` / `impeccable-live-end`)                                                                                                           |
| **D54** | **O componente `Alert` embute `border-l-[4px]`, o acento lateral que o Design System bane — em todo uso no produto.** A faixa colorida à esquerda foi removida à mão dos cards de paciente e de terapeuta em 20/08/2026, mas `src/components/ui/alert.tsx` a aplica no próprio componente (`"border-l-[4px]"` no `cn`, mais `bordaEsquerda` por severidade), então cada `<Alert>` da aplicação continua desenhando a stripe.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    | Corrigir no componente muda a aparência de toda mensagem de erro/aviso/sucesso do produto de uma vez: é mudança visual ampla, não local, e precisa de uma passada de verificação própria. Não bloqueia nada; fica registrado para não ser "descoberto" de novo a cada auditoria de UI.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            | `src/components/ui/alert.tsx` (`border-l-[4px]`, mapa `estilo[].bordaEsquerda`) · `docs/ux/design-system-espectro-brutal.md`                                                                |
...
- **Entregas principais:**
  - `src/lib/email/webhook.ts`: Helper de validação de assinatura Svix (`svix-id`, `svix-timestamp`, `svix-signature`) contra `RESEND_WEBHOOK_SECRET` e processador de eventos `email.bounced`, `email.complained` e entregas.
  ...
  - `src/lib/email/webhook.test.ts` e `src/app/api/webhooks/resend/route.test.ts`: Cobertura completa de testes unitários e de integração (14 testes novos) cobrindo verificação de assinatura, rejeição de payloads inválidos, tratamento de bounces/complaints, tolerância a eventos desconhecidos e garantia de não-vazamento de PII.
  - `.env.example`: Documentação detalhada da variável `RESEND_WEBHOOK_SECRET`.
- **Validação e Métricas (Medido, não presumido):**
  - `pnpm typecheck`: 0 erros.
  - `pnpm lint`: 0 erros (9 warnings pré-existentes).
  - `pnpm test`: 243/243 arquivos de teste passando (1.731/1.731 testes verdes).

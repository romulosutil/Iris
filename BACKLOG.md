...
| **D43** | **A cobrança de ativação do Pix Automático nunca foi medida no trilho real, e a #289 classifica-a por AUSÊNCIA.** `classificarFalhaDeConciliacao` trata "sem id de instrução **e** sem `externalReference`" como ativação/avulsa — desfecho esperado, que não gera alarme. A prova de que a ativação chega assim é **por construção** (ela nasce do `immediateQrCode`, que não aceita `externalReference`, medido na #321) e **nunca foi observada em produção**: o sandbox do Asaas não ativa Pix Automático. Se a ativação real chegar **com** instrução, ela vira alarme — falso e barulhento, mas do lado seguro. Junto disso, um segundo fato pré-existente ficou visível: `normalizarEventoAsaas` trata **qualquer** `externalReference` não-vazia como cobrança nossa, então cobrança de terceiro na mesma conta Asaas vira `cobranca.*` e dispara `avisarRecusaQueNaoConciliou` — o aviso indevido **não foi corrigido** na #289, só ficou diagnosticável (motivo com texto próprio). Fecha no ensaio com clínica de teste em produção.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| **D44** | **O "início do próximo ciclo" da 4ª validação do Asaas é lido de `subscription.ciclo_atual_fim`, e o alinhamento entre a recorrência do gateway e o ciclo do Iris NUNCA foi medido.** A validação 4 fala do próximo ciclo **da recorrência dele**; a cobrança retentada é a do ciclo **do Iris**. Se a recorrência do Asaas estiver um ciclo atrás, o teto certo já estaria no passado e **toda** chamada de retentativa voltaria 400 `colide_com_proximo_ciclo` — as 3 tentativas queimadas sem debitar um centavo, e o sintoma seria "a retentativa nunca funciona", não um erro nomeado. Não é mensurável no sandbox (nenhuma autorização chega a `ACTIVE`, #321). **Primeira medição possível: o ensaio com clínica de teste em produção.** Escrito no docblock da varredura (`src/lib/billing/subscription.ts`). Nasceu na #322, 17/08/2026.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| **D45** | **O contador de 3 tentativas do Asaas pode ser por instrução, não por cobrança — e a varredura escolhe sempre a instrução recusada mais recente.** A escolha deixou de ser `lista[0]` (arbitrária, dependente da ordem que a API devolvesse) e passou a ser determinística: a mais recente por `dateCreated`, com o maior `id` como desempate. Isso é correto se o orçamento de 3 for **por cobrança**. Se for **por instrução**, retentar sempre a mais nova **abre orçamento além de 3** — e o Asaas passa a debitar mais vezes do que a política autoriza. `src/lib/billing/provider/asaas.ts`. **Não medido**; entra no ensaio em produção. Nasceu na #322, 17/08/2026.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |

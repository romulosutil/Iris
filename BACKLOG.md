...
| **D38** | **A rota `fechar-ciclos` descarta `resultados` inteiro sob falha parcial.** Se `cancelarAssinaturasComCarenciaVencida` lançar, o 500 leva junto o corpo que carrega o `providerChargeId` de **cada cobrança já emitida no gateway** naquela passada — e o job (`scripts/fechamento-ciclo-billing.mjs`) só grava esse JSON.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      | É a **mesma classe** que o `carenciaTruncado` da #319 existe para evitar, e o princípio dela vale aqui sem tradução: **perder o registro de um ato irreversível é pior que cortar devagar.** A cobrança foi emitida no Asaas de verdade; o que se perde é a única prova de que ela existe do nosso lado. Correção natural — `try` próprio na última etapa da rota + campo `carenciaAbortada` no corpo 200 — **muda o contrato da rota e o formato do log do job**, e por isso não entra de carona: **decisão pendente do Rômulo** (`checkpoint.md` §3b).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          | #319 · #318 · `src/app/api/internal/billing/fechar-ciclos/route.ts` · `scripts/fechamento-ciclo-billing.mjs`                                                                                |

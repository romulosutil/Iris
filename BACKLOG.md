...
**Próximo passo (D86):** depois do merge, **Actions → Smoke do provider de extração → Run workflow**. Será a primeira vez que alguém sabe se `gemini-3.6-flash` está vivo.

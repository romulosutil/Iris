...
| **D52** | ~~**`scripts/seed-demo-account.ts` cria todas as contas de demonstração com a senha literal `SenhaLocal123!`, sem distinção de ambiente.**~~ **Entregue em 21/08/2026 (PR #412).** Guardrail adicionado em `scripts/seed-demo-account.ts` e `scripts/seed.ts` exigindo que a conexão aponte para `localhost`/`127.0.0.1` ou a env explícita `ALLOW_SEED_REMOTE=true` esteja ativa, abortando com erro antes de qualquer escrita.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                | Evita execução acidental de seeds destrutivos ou com senhas literais contra banco de staging ou produção. PR aberta para merge.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   | #412 · `scripts/seed-demo-account.ts` · `scripts/seed.ts` · `package.json` (`seed:custom`)                                                                                                  |
| **D53** | ~~**Ferramenta de preview de UI injeta script `localhost:8400/live.js` em `layout.tsx`.**~~ **Entregue em 21/08/2026 (PR #413).** Guardrail de teste unitário/CI adicionado (`src/app/layout.guard.test.ts`) que analisa `src/app/layout.tsx` e falha a suíte se encontrar URLs de dev local (`localhost:8400`) ou marcadores `impeccable-live`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                | Protege o repositório e o CI contra subida acidental de tags de script que apontem para portas de desenvolvimento locais. PR aberta para merge.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   | #413 · `src/app/layout.tsx` · `src/app/layout.guard.test.ts`                                                                                                                                |

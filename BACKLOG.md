...
| **D76** | **Modelo de papel não suporta mais de um coordenador por clínica.** Levantado ao decidir #517 (C5, opção 3 — recepção fica sem agendar). Hoje o negócio parte de "o coordenador que define a demanda"; a modelagem assume implicitamente um coordenador só por clínica. Não é bug — é lacuna de modelo, sem issue ainda. | Só passa a doer se o negócio crescer para clínicas com demanda dividida entre coordenadores. Registrar aqui evita perder o achado até virar prioridade. | issue #517 · `docs/ux/jornada-sessao-unificada.md` §2/§4 (E4) |

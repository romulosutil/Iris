...
| **7**   | Self-Service & Growth (onboarding + pagamento autônomo)  | 🚧 Em construção (trial #175 ✅ · arquivamento #174 parcial · Fase A+B da spec fechadas em código (T1-T13) · **nada mergeado em `main`/produção ainda** · Fase C — remoção do MP (T14-T18) — é o próximo passo) | Issue #36                |

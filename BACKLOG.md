...
| **D19** | **Coleta de CPF sem revisão jurídica** (#191). Passamos a coletar e persistir CPF do paciente ou do responsável; `docs/legal/` não foi tocado.                                                                                                                                                                                                                                                                                                                                                                                                                                                    | Dado pessoal novo exige finalidade declarada no termo de consentimento e na política de privacidade ("prevenção a fraude" não está lá hoje). Mudança em `docs/legal/` exige aprovação do Rômulo (CLAUDE.md), então ficou fora do escopo técnico — mas é bloqueio de LGPD antes de cliente real, não item cosmético. Método de validação: o mesmo da ratificação por silêncio já usada no projeto (advogado lê ao vivo).                                                                                                            | #191 · `docs/legal/`                                                                                          |
...
2. **Revisão jurídica da coleta de CPF.** Passamos a coletar um dado pessoal
   novo. `docs/legal/` não foi tocado (mudança lá exige aprovação do Rômulo, por
   CLAUDE.md) — mas o termo de consentimento e a política de privacidade
   provavelmente precisam citar CPF e a finalidade "prevenção a fraude".

...
| **7**   | Self-Service & Growth (onboarding + pagamento autônomo)  | 🚧 Em construção (trial #175 ✅ · arquivamento #174 parcial · Fases A+B+C da spec fechadas em código (T1-T18) · **nada mergeado em `main`/produção ainda**, exceto o T17 (envs), que o Rômulo aplicou direto no Easypanel · próximo passo é o merge em `main` e o deploy, que aplica a `0090` (backfill) e a `0091` (drop da tabela do MP)) | Issue #36                |
